      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl">
          ...
          <p className="text-gray-400 text-base leading-relaxed mb-12">
            ...
            <br />
            개발, 콘텐츠, 자동화, 포트폴리오 협업에 대해 이야기하고 싶다면 편하게 연락해주세요.
          </p>

          {/* 버튼 그룹 — 모바일: 2열 grid / 데스크톱: flex row */}
              ...
              return (
                <a
                  ...
                  className={[
                    ...
                    isEmail
                      ? "border-gold-500/50 text-gold-400 hover:border-gold-400 hover:shadow-[0_0_16px_rgba(212,168,67,0.15)]"
                      : "border-dark-400 text-gray-400 hover:border-gold-500/50 hover:text-gold-400",
                  ].join(" ")}
                >
