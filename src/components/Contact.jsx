      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl">
          <h2 className="text-3xl md:text-4xl font-semibold leading-snug mb-6">
            함께 이야기
            <br />
            <span className="text-gradient-gold">나눠봐요.</span>
          </h2>
          <p className="text-gray-400 text-base leading-relaxed mb-12">
            작은 아이디어를 실제 결과물로 만드는 일을 좋아합니다.
            <br />
            개발, 콘텐츠, AI 활용에 대해 이야기하고 싶다면 편하게 연락해주세요.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            {contactLinks.map((link) => (
              <a
                ...
                className="inline-flex items-center gap-2.5 px-5 py-3 rounded-xl border border-dark-400 hover:border-gold-500/50 text-gray-400 hover:text-gold-400 transition-all duration-200 text-sm group"
              >
